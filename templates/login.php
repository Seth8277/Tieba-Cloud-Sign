...
<div class="input-group">
  ...
  <?php doAction('login_page_3'); ?>
	...
	<?php echo SYSTEM_FN ?> V<?php echo SYSTEM_VER ?> <?php echo SYSTEM_VER_NOTE ?> // 作者: <a href="https://kenvix.com" target="_blank">Kenvix</a> @ <a href="https://www.stusgame.com/forum.php" target="_blank">StusGame</a> &amp; <a href="https://www.mokeyjay.com/" target="_blank">mokeyjay</a> &amp; <a href="https://fyy1999.lofter.com/" target="_blank">FYY</a>
	<?php
  $icp=option::get('icp');
    if (!empty($icp)) {
